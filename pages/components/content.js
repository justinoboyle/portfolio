...
export default () => (
  <prop className="content">
    ...
    <Section name="Groups and Organizations">
      <ThumbnailLayout>
        <Thumbnail subtext="Roles: Developer and Systems Engineer" link="https://nfmstudios.com/" image="/static/nfm.png" title="NFM Studios" content="Founded in the summer of 2016, we crafted our team, and our goal is that we will take an active role in web development to help the eSports industry." />
